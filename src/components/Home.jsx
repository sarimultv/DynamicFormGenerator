  ...
  return (
    ...
    >
      ...
      <ul className="pb-4 flex justify-center">
        <li
          className="md:mt-5 md:mr-3 w-[4rem] h-[4rem] flex justify-center items-center md:p-3 p-3 bg-gray-200 text-black rounded-full cursor-pointer hover:bg-gray-800 hover:text-white"
